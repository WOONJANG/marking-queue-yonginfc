(function () {
  ...
  function loadBaseData() {
    return AppApi.jsonp({ mode: 'public', statusFilter: 'all' })
      .then(function (res) {
        if (!res || !res.success) {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    filterAllBtn.addEventListener('click', function () { setStatusFilter('all'); });
    filterWaitingBtn.addEventListener('click', function () { setStatusFilter('waiting'); });
    filterCompleteBtn.addEventListener('click', function () { setStatusFilter('complete'); });
